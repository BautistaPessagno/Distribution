...
- Map: `docs/issues/<effort>/map.md`, containing the Notes, Decisions-so-far, and Fog sections
...
- Frontier: scan `docs/issues/<effort>/issues/` for open, unblocked, and unclaimed files. The lowest number wins.
